...
My initial reaction is that this one starts with "Subfossil lemurs" and therefore makes it clear what the article is about. It also flows much better than the first auto summary. But then I realized, this summarizer simply just stated the first 5 sentences from the original article and so I'm unsure if it does anything more sophisticated than that.
