...
# Load movie plots
plot.data <- read_dir("E:/Projects/text.summarizer/data/movie.plots/") %>%
        group_by(document) %>%
...
I developed this tool as a quick and easy way for me to obtain summaries of text without worrying about whether my data will be logged or captured in some way. I plan on keeping it free for use for everyone for as long as I am able to.
