...
3. I can see a few easy to interpret clusters of text from the hearings:
+ sexual behaviour with students
+ borderline sexual behaviour, but not full on sex (i.e. flirty behaviour)
+ physical abuse
+ mental abuse
