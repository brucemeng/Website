...
I used **[autoSmry](../../project/autosmry/)** to help narrow down the words to the most important ones.
...
The visualization is divided up into words that were exclusively male (in blue), exclusively female (in pink), and words that were in both genders. While the size of the circle represents how frequently that word came up.
...
2. I was able to identify 6 clusters of words from the text:
        + Frequency: there were many words that related to how frequent the teacher approached the student(s)
        + Judgement: this was how the Committee judged the teacher misconduct
        + Abuse: there were incidents of both physical and mental abuse by teachers
        + Sexual: sexual behaviour with students
        + Flirtatious: borderline sexual behaviour with students
        + Punishment: this was how the teacher was punished for their misconduct

3. The word "consensual" only appears for female teachers. Male teachers were rude, profane/offensive/disrepectful and in general, more violent.

4. Some odd clusters of text:
        + hot/cold/wet conditions? - I clustered it under "Torture"
