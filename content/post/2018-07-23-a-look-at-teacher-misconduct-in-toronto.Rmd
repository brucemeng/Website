...
The visualization is divided up into words that were exclusively male (in blue), exclusively female (in pink), and words that were in both genders.
...
3. The word "consensual" only appears for female teachers.
