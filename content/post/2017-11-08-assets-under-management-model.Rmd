...
Here's a comparison of the InvestorLine AUM model with actual AUM (model: dashed blue line, actual: solid black line):
...
Here's a comparison of the Full Service Investing AUM model with actual AUM (model: dashed blue line, actual: solid black line):
...
fsi.plot <- ggplot(data = fsi.act.pred, aes(x = Date)) +
                ...
                geom_line(aes(y = AUM.TOTAL)) +
                geom_line(aes(y = AUM.Predict.Total), linetype = "dashed", colour = "blue") +
