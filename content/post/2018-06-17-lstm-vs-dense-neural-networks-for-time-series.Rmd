...
The results are fairly good for all three models. Dense looks to be superior for the first 2/3 of the way, while GRU appears to be better in the last 1/3. Let's see some scores (RMSE) to settle this more definitively:
...
The ensemble model takes it, with the really good dense layer model coming in second. The GRU was just a tad worse, and maybe with some more tuning of the hyperparamters it may become better.