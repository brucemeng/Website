...
```{r xmas.plot, echo = F, fig.height=4, message=F}
...
In Canada, we have a discount shopping period immediately after Christmas Day called Boxing Day, although recently this has been extended to Boxing Week (and now Canadian stores are also doing Black Friday sales too). I actually thought that the week following Christmas would've been higher, but it seems that's not the case.