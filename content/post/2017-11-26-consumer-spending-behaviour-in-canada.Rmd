...
With the holidays being so near, I was asked during a casual conversation whether there were any differences in spending patterns throughout the year for Canadians.
...
ggplot(spend.xmas, aes(x = avg.s, y = daynumb, fill = ..x..)) +
        geom_density_ridges_gradient(scale = 1.5, rel_min_height = 0.3, gradient_lwd = 1.,
                                     color = "black") +
        scale_fill_viridis(name = "Daily Spend", option = "magma") +
        xlab("Average Daily Spending") +
        scale_x_continuous(labels = dollar_format(), expand = c(0.01,0)) +
