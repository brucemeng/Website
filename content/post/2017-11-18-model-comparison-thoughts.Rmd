...
By transforming the scores to the logarithmic scale, it is now symmetrical and bound between ($-\infty$, $+\infty$). Thus, a very very good prediction has a proportionate amount of visual space as a very very bad prediction. (Or as xkcd would put it... I just took the easy way out... =D).
