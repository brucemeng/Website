...
```{r data}
# Link to income data: https://docs.google.com/spreadsheet/pub?key=phAwcNAVuyj1jiMAkmq1iMg&output=xlsx
...
data.income %>%
        gather(year, value, `1800.0`:`2015.0`) -> data.income.clean
...
data.babies %>%
        gather(year, value, `1800.0`:`2015.0`) -> data.babies.clean
