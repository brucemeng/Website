...
```{r data, warnings = F, echo = F, message = F}
library(readxl)
...
```{r gganimate, message = F, warning = F}
library(gganimate)
library(tweenr)
...
# Animate Plot
# gganimate(p, title_frame = T, interval = 0.02, "../../static/img/gganimate.gif", ani.width = 1024, ani.height = 1024) #<- Not run to save render time
